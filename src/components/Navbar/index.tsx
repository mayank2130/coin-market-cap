...
import { MenuIcon, QrCodeIcon, SearchIcon } from "lucide-react";
    ...
    <header className="bg-[#0d1421] border-b border-[#222531] ">
      <div className="px-4 py-4 flex items-center  justify-between">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-bold mb-1">
        ...
        <div className="flex items-center gap-2 sm:gap-4 w-full justify-end">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <button onClick={() => setIsOpen(true)} className="flex items-center gap-1 sm:gap-2 bg-[#222531] rounded-md py-1 sm:py-1.5 px-2 sm:px-3 text-gray-400 hover:bg-[#2c3241] w-40 sm:w-60">
